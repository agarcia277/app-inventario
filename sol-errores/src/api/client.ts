...
export const getFloorplanCategories = () => apiClient.get('/floorplan-categories');
export const createFloorplanCategory = (data: object) => apiClient.post('/floorplan-categories', data);
export const updateFloorplanCategory = (id: number, data: object) => apiClient.put(`/floorplan-categories/${id}`, data);
export const deleteFloorplanCategory = (id: number) => apiClient.delete(`/floorplan-categories/${id}`);
export const uploadFloorplanCategoryImage = (file: File) => {
  const formData = new FormData();
  formData.append('image', file);
  return apiClient.post('/floorplan-categories/image', formData, {
    headers: { 'Content-Type': 'multipart/form-data' },
  });
};
