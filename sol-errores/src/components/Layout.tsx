      ...
      >
        ...
        <div className="px-3 py-4 border-t border-gray-800">
          <div className="flex items-center gap-3 px-3 py-2.5 rounded-lg bg-gray-800">
            ...
            <div className="w-8 h-8 rounded-full flex-shrink-0 overflow-hidden bg-blue-600 flex items-center justify-center text-xs font-bold ring-2 ring-blue-500/30">
              {user?.avatar_url ? (
                <img
                  src={user.avatar_url}
                  alt={user.full_name}
